...
//スクロールエフェクト
const elementsToShow = document.querySelectorAll('.campaign-info__left, .campaign-info__right, .single, .responsive-img');
const config = {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const img = new Image();
    img.classList.add("responsive-img2");
